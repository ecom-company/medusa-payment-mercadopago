...
var MercadopagoProviderService = /*#__PURE__*/function (_AbstractPaymentServi) {
  (0, _inherits2["default"])(MercadopagoProviderService, _AbstractPaymentServi);
  ...
  (0, _createClass2["default"])(MercadopagoProviderService, [{
    ...
    value: function () {
      var _updatePaymentData = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(paymentSessionData, data) {
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                return _context2.abrupt("return", _objectSpread(_objectSpread({}, paymentSessionData), data));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                _context3.next = 9;
                return this.mercadopago_.preferences.create(preference);
    ...
    key: "retrievePayment",
    value: function () {
      var _retrievePayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(paymentData) {
        var res;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return this.mercadopago_.payment.get(paymentData.id);
    ...
    value: function () {
      var _updatePayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(paymentSessionData, cart) {
        var region_id, _yield$this$regionSer2, currency_code, items, preference, paymentIntent;
    ...
    value: function () {
      var _authorizePayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(paymentSession, context) {
        var status;
    ...
    key: "capturePayment",
    value: function () {
      var _capturePayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(payment) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                return _context7.abrupt("return", payment.data);
    ...
    key: "refundPayment",
    value: function () {
      var _refundPayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(payment, refundAmount) {
        var paymentData;
            ...
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                return this.mercadopago_.refund.create({
                  ...
                  amount: Math.round((0, _medusaCoreUtils.humanizeAmount)(refundAmount, payment.currency_code))
                });
              ...
              case 5:
                ...
                return _context8.abrupt("return", paymentData);
    ...
    key: "cancelPayment",
    value: function () {
      var _cancelPayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(payment) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                ...
                isCancelled = paymentData.status === "cancelled";
                isFullyRefund = paymentData.status === "refunded" && paymentData.transaction_amount === paymentData.transaction_amount_refunded;
                ...
                return _context9.abrupt("return", paymentData);
              ...
              case 11:
                ...
                _context9.next = 14;
                return this.mercadopago_.payment.cancel(payment.data.id);
    ...
    key: "deletePayment",
    value: function () {
      var _deletePayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(paymentSession) {
    ...
    key: "getStatus",
    value: function () {
      var _getStatus = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee11(data) {
        var paymentIntent;
        return _regenerator["default"].wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.next = 2;
                return this.retrievePayment(data);

              case 2:
                paymentIntent = _context11.sent;
                _context11.t0 = paymentIntent.status;
                _context11.next = _context11.t0 === "approved" ? 6 : _context11.t0 === "authorized" ? 6 : _context11.t0 === "refunded" ? 7 : _context11.t0 === "charged_back" ? 7 : _context11.t0 === "cancelled" ? 7 : _context11.t0 === "rejected" ? 8 : _context11.t0 === "pending" ? 9 : _context11.t0 === "in_process" ? 9 : _context11.t0 === "in_mediation" ? 9 : 10;
                break;

              case 6:
                return _context11.abrupt("return", _medusa.PaymentSessionStatus.AUTHORIZED);

              case 7:
                return _context11.abrupt("return", _medusa.PaymentSessionStatus.CANCELED);

              case 8:
                return _context11.abrupt("return", _medusa.PaymentSessionStatus.ERROR);

              case 9:
                return _context11.abrupt("return", _medusa.PaymentSessionStatus.PENDING);
    ...
    value: function () {
      var _notificationPayment = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(body) {
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                _context12.next = 3;
                return this.retrievePayment(body.data);

              case 3:
                payment = _context12.sent;
                return _context12.abrupt("return", _objectSpread(_objectSpread({}, body), {}, {
                  payment: payment
                }));
    ...
    value: function () {
      var _createPaymentNew = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee13(paymentInput) {
    ...
    value: function () {
      var _updatePaymentNew = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee14(paymentSessionData, paymentInput) {
...
(0, _defineProperty2["default"])(MercadopagoProviderService, "identifier", "mercadopago");
